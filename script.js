...
element:product,
text:product.textContent.toLowerCase()
...
<option data-gram="52gm" data-price="15" data-unit="pcs">52gm - ₹15 pcs</option>
`;
...
message +=
`• ${displayName} × ${item.qty}${unitText}%0A`;
